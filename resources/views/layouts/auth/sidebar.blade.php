   ...
   <ul class="metismenu" id="menu">
     ...
     <li>
       ...
       <ul>
         ...
         <li> <a class="collapse-item" href="{{route('users.type', 'shuttle')}}">Airport Shuttle Owners</a>
         </li>
       </ul>
     </li>
     ...
     <li>
       ...
       <ul>
         ...
         <li><a class="collapse-item" href="{{route('flightrequests.index')}}">Flight Requests</a></li>
       </ul>
     </li>
     <li>
     ...
     <li>
       ...
       <ul>
         ...
         <li> <a class="collapse-item" href="{{route('users.bus.index', auth()->user()->id)}}">Buses</a>
         </li>
