                                                ...
                                                <div class="flight_card">
                                                        ...
                                                        <div class="split_cards">
                                                            ...
                                                            <div class="card_one">
                                                                ...
                                                                <p>
                                                                    <small><?php echo e($arrival); ?>  (<?php echo e($lastSegment->arrival->iataCode); ?>)</small>
                                                                </p>                                                           
                                                            </div>
                                                        </div>
                                                        <div class="upper_card">
                                                        ...
                                                        <div class="upper_card">
                                                            <p class="text-muted mb-1"><small>Returning Flight</small>
                                                                <small class="ms-1">(<?php echo e(\Carbon\Carbon::parse($second_firstSegment->departure->at)->format('d-m-Y')); ?>)</small>
                                                            </p>
                                                        </div>
                                                        <div class="split_cards">
                                                            <div class="card_one">
                                                            ...
                                                            <div class="card_one">
                                                                <p>
                                                                    <small><?php echo e($arrival); ?>  (<?php echo e($second_firstSegment->departure->iataCode); ?>)</small>
                                                                </p>
                                                                <p>
                                                                    <small><img src="<?php echo e($second_imageUrl); ?>" alt="<?php echo e($second_airlineCode); ?>" title="<?php echo e($second_airlineCode); ?>" height="20px"></small>
                                                                    <small class="ms-1"> <?php echo e($flight->travelerPricings[0]->fareDetailsBySegment[0]->cabin); ?></small>
                                                                </p>
                                                                <p>
                                                                    <small><?php echo e($departure); ?>  (<?php echo e($second_lastSegment->arrival->iataCode); ?>)</small>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="upper_card">
                                                    ...
                                                    <div class="lower_card h-100">
                                                        ...
                                                        <form action="<?php echo e(route('flight-price')); ?>" id="form<?php echo e($flight->id); ?>" method="POST" class="form">                                                  
                                                            <?php echo csrf_field(); ?>
                                                            <input type="hidden" name="flight" value="<?php echo e(json_encode($flight)); ?>" />
                                                            <input type="hidden" name="flightofferid" value="<?php echo e($flight->id); ?>" />
                                ...
                                <div class="my-3">
                                    <div class="flight_card">
                                            ...
                                            <div class="upper_card">
                                                ...
                                                ?>
                                                <p class="text-muted mb-1"><small><?php echo e($airline ? $airline->name : 'Unknown Airline'); ?></small>
                                                    <small class="ms-1">(<?php echo e($firstSegment->carrierCode); ?>)</small>                                            
                                                </p>
                                            </div>
                                            ...
                                            <div class="lower_card h-100">
                                                ...
                                                <form action="<?php echo e(route('flight-seat-map')); ?>" id="form<?php echo e($flight->id); ?>" method="POST" class="form"> 
                                                    <?php echo csrf_field(); ?>                                                   
                                                    <input type="hidden" name="flight" value="<?php echo e(json_encode($flight) ?? ''); ?>" />
                                                    <input type="hidden" name="departure" value="<?php echo e($departure ?? ''); ?>" />
                                                    <input type="hidden" name="flight_option" value="<?php echo e($flight_option ?? ''); ?>" />
