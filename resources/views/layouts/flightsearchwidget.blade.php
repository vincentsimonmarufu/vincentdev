                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="alert alert-danger">
                                                    ...
                                                    <ul>
                                                        <li>1. Ensure accurate information for the departure and destination fields, selecting from the provided autocomplete suggestions.</li>
                                        ...
                                        <div class="row gx-3">
                                            <div class="container">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">
                                                                ...
                                                                From
                                                                <input type="text" class="form-control "  placeholder="Where From" name="origin_airport" id="airportInput" required>
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">
                                                                <!--<i class="bi bi-geo"></i>-->
                                                                Destination
                                                                <input type="text" class="form-control " style="width: 100%;" placeholder="Where To" name="destination_airport" id="airportTo" required>  
                                                                <!-- Add a hidden input field to store the selected IATA code -->
                                                ...
                                                <div class="row">                            
                                                    <div class="col-md-4 col-sm-12 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">                                          
                                                                ...
                                                                <input type="number" min="0" value="1" class="form-control" name="adults" id="adults-input" required>
                                                                <div id="adult-message" class="message" style="display:none;">At least one adult must be selected</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">                                          
                                                                ...
                                                                <input type="number" min="0" value="0" class="form-control" name="children" id="children-input"> 
                                                                <div id="children-message" class="message" style="display:none;">Maximum 5 children allowed</div> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-12 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">                                          
                                                                ...
                                                                <input type="number" value="0" min="0" class="form-control" name="infants" id="infants-input">                                          
                                                    ...
                                                    <span id="adult-infant-message" class="text-center" style="display:none; color:red; text-align: left; margin-left: 33.33%;"></span>
                                                    <span id="adult-child-message" class="text-center" style="display:none; color:red; text-align: left; margin-left: 33.33%;"></span>
                                                    <span id="total-message" class="text-center" style="display:none; color:red; text-align: left; margin-left: 33.33%;"></span>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-sm-6 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">
                                                                Departure Date
                                                                <input type="date" min="<?php echo $currentDate; ?>" max="<?php echo $oneYearLater; ?>" class="form-control" id="" placeholder="Select Departure Date" name="departure_date" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 col-sm-6 col-12">
                                                        <div class="mt-3">
                                                            <div class="input-icon">
                                                                Return Date
                                                                <input type="date" min="<?php echo $currentDate; ?>" max="<?php echo $oneYearLater; ?>" class="form-control" id="" placeholder="Select Return Date" name="return_date">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            @foreach($flights as $flight) 
                                                ...
                                                <div class="flight_card">
                                                        <div class="upper_card">
                                                            <p class="text-muted mb-1"><small>Departing Flight</small>
                                                                <small class="ms-1">({{  \Carbon\Carbon::parse($firstSegment->departure->at)->format('d-m-Y') }})</small>
                                                            </p>
                                                        </div>
                                                        <div class="split_cards">
                                                            ...
                                                            <div class="card_one">
                                                                <p>
                                                                    <small>{{ $departure }}  ({{  $firstSegment->departure->iataCode }})</small>
                                                                </p>
                                                                <p>
                                                                    <small><img src="{{ $imageUrl }}" alt="{{ $airlineCode }}" title="{{ $airlineCode }}" height="20px"></small>
                                                                    <small class="ms-1"> {{ $flight->travelerPricings[0]->fareDetailsBySegment[0]->cabin }}</small>
                                                                </p>
                                                                <p>
                                                                    <small>{{ $arrival }}  ({{  $lastSegment->arrival->iataCode }})</small>
                                                                </p>                                                           
                                                            </div>
                                                        </div>
                                                        <div class="upper_card">
                                                            <p class="text-muted mb-1"><small>{{\App\Models\Airline::where('code', $firstSegment->carrierCode)->first()->name}}</small>
                                                        ...
                                                        <div class="upper_card">
                                                            <p class="text-muted mb-1"><small>Returning Flight</small>
                                                                <small class="ms-1">({{  \Carbon\Carbon::parse($second_firstSegment->departure->at)->format('d-m-Y') }})</small>
                                                            </p>
                                                        </div>
                                                        <div class="split_cards">
                                                            <div class="card_one">
                                                            ...
                                                            <div class="card_one">
                                                                <p>
                                                                    <small>{{ $arrival }}  ({{  $second_firstSegment->departure->iataCode }})</small>
                                                                </p>
                                                                <p>
                                                                    <small><img src="{{ $second_imageUrl }}" alt="{{ $second_airlineCode }}" title="{{ $second_airlineCode }}" height="20px"></small>
                                                                    <small class="ms-1"> {{ $flight->travelerPricings[0]->fareDetailsBySegment[0]->cabin }}</small>
                                                                </p>
                                                                <p>
                                                                    <small>{{ $departure }}  ({{  $second_lastSegment->arrival->iataCode }})</small>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="upper_card">
                                                    ...
                                                    <div class="lower_card h-100">
                                                        ...
                                                        <form action="{{ route('flight-price') }}" id="form{{ $flight->id }}" method="POST" class="form">                                                  
                                                            @csrf
                                                            <input type="hidden" name="flight" value="{{ json_encode($flight) }}" />
                                                            <input type="hidden" name="flightofferid" value="{{ $flight->id }}" />
                                ...
                                <div class="my-3">
                                    <div class="flight_card">
                                            ...
                                            <div class="upper_card">{{-- \App\Models\Airline::where('code', $firstSegment->carrierCode)->first()->name --}}
                                                @php
                                                    $airline = \App\Models\Airline::where('code', $firstSegment->carrierCode)->first();
                                                @endphp
                                                <p class="text-muted mb-1"><small>{{ $airline ? $airline->name : 'Unknown Airline' }}</small>
                                                    <small class="ms-1">({{  $firstSegment->carrierCode }})</small>                                            
                                                </p>
                                            </div>
                                            ...
                                            <div class="lower_card h-100">
                                                ...
                                                <form action="{{ route('flight-seat-map') }}" id="form{{ $flight->id }}" method="POST" class="form"> 
                                                    @csrf                                                   
                                                    <input type="hidden" name="flight" value="{{ json_encode($flight) ?? ''}}" />
                                                    <input type="hidden" name="departure" value="{{ $departure ?? ''}}" />
                                                    <input type="hidden" name="flight_option" value="{{ $flight_option ?? ''}}" />
