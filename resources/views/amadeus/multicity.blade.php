...
<section id="flight_search" class="card" >
    <div class="container">
        <form action="{{ route('multicity-search') }}" method="POST" id="multicity">
            @csrf
                             ...
                             @endphp
                                  ...
                                  <div class="split_cards">
                                      <div class="card_one">
                                          ...
                                          <p>
                                              <small>{{ formatDuration( $itineraries->duration) }}</small>
                                          </p>
                                          <p>
                                  ...
                                  <div class="lower_card h-100">
                                      ...
                                      <form action="/flight-price" id="form{{ $flight->id }}" method="POST" class="form">
                                          @csrf                                          
                                          ...
                                          <button type="button" class="btn btn-primary" onclick="submitForm('form{{ $flight->id }}')">Select</button>
                                      </form>
                                  </div>
    ...
    $(document).ready(function () {
        $('#flightOption').change(function () {
            if ($(this).val() === 'one-way' || $(this).val() === 'return' ) {
                        ...
                        window.location.href = '{{ route("flights.searching") }}';
                }
        });
