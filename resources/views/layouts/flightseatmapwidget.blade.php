    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <h4 class="mt-2" style="margin-left: 10px;">
                Flight({{ $seatMapData[0]['carrierCode'] }}{{ $seatMapData[0]['number'] }}) seats detail</h4>
            <div class="container mt-2">
                ...
                @for ($i = 0; $i < $metaCount; $i++)
                    ...
                    <div id="container-{{ $i + 1 }}" class="container-box {{ $newactive }}"
                        style="overflow: auto;">
                        @if ($i == 0)
                        ...
                        @foreach ($seatMapData[$i]['decks'] as $deck)
                            <div class="deck-container"
                                style="width: {{ $deck['deckConfiguration']['width'] * 40 }}px;">
