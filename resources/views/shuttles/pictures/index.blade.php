    ...
    <div class="row">
                ...
                <div class="card-footer">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-sm-4">
                            ...
                            {!!Form::open(['action'=>['App\Http\Controllers\ShuttlePictureController@destroy', $shuttle->id, $picture->id], 'method'=>'DELETE'])!!}
        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-body">
                    {!!Form::open(['action'=>['App\Http\Controllers\ShuttlePictureController@store', $shuttle->id], 'files'=>true])!!}
                    <div class="mb-3 row">
