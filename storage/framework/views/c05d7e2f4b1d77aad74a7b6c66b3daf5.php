...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <div class="col-lg-12">
                <?php echo Form::open(['action'=>'App\Http\Controllers\BusController@store', 'files'=>true]); ?>

                <?php echo csrf_field(); ?>
                <div class="mb-3">
                    <label class="form-label">Compamy Name / Owner Name</label>
                    <?php echo e(Form::text('name', null, ['id'=>'name', 'class'=>'form-control', 'required', 'placeholder'=>'Company Name / Owner Name'])); ?>

                </div>
                <div class="mb-3">
                    <label class="form-label">Number of Seats</label>
                    <?php echo e(Form::number('seater', null, ['id'=>'seater', 'class'=>'form-control', 'required', 'placeholder'=>'Number of seats'])); ?>
...
<?php echo $__env->make('layouts.auth.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vince\Documents\Workspace\Abisiniya\abisiniya82\resources\views/bus/create.blade.php ENDPATH**/ ?>