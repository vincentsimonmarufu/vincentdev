...
<form action="<?php echo e(route('shuttlesearch')); ?>" method="GET" class="search-form">    
    <div class="form-group">
        ...
        <select id="mySelect1" name="start_airport_address" class="pickup">
            <?php $__currentLoopData = $airports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($airport); ?>"><?php echo e($airport); ?></option>
...
<?php /**PATH C:\Users\vince\Documents\Workspace\Abisiniya\abisiniya82\resources\views/shuttle_search_form.blade.php ENDPATH**/ ?>