    ...
    -->
      ...
      <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
          <a href="{{ route('read_all') }}"> <h6 class="dropdown-header">
          
             Read
                  All ({{ count(auth()->user()->unreadNotifications) }} )
         ...
         @foreach ($notifications as $notification)
          <a class="mr-3 dropdown-item d-flex align-items-center
          @if ($notification->unread())
         alert alert-success
          @endif
        " href="{{ route('notification_read', ['id' => $notification->id]) }}">
           <!-- <div class="mr-3">
