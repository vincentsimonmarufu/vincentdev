          ...
          <div class="row mt-5 justify-content-center" data-aos="fade-up">
            ...
            <div class="col-xs-6 col-sm-4">
              ...
              <div class="input-group">
                <select name="from" id="airportDepart" class="form-control select2" style="100%" required>
            ...
            <div class="col-xs-6 col-sm-4">
              ...
              <div class="input-group">
                ...
                <select id="aiportDest" class="form-control select2" name="to" required>
                  <option value="">Select Airport</option>
                </select>
              </div>
            </div>
            ...
            <div class="col-xs-6 col-sm-3">
              ...
              <div class="input-group">
                ...
                <input name="departure_date" type="date" class="form-control" min="{{ $date }}" max="{{  $maxDate }}" id="dateFrom" name="Text" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'yyyy/MM/dd';}" required="">
              </div>
            </div>
            <div class="col-xs-6 col-sm-3">
            ...
            <div class="col-xs-6 col-sm-3">
              ...
              <select name="travel_class" class="form-control" id="travelClass" required>
            ...
            <div class="col-md-12 pb-3">
              ...
              <p class="text-center"><br>
                <button class="btn btn-success" type="submit">Submit<i class="bx bx-right-arrow-alt"></i></button>
              </p>
            </div>
          </div>
        </div>
...
<script type="text/javascript">
  ...
  for (x in country) {
    ...
    document.getElementById("aiportDest").appendChild(sel);
  }
  ...
  for (x in country) {
    ...
    sel.innerHTML = country[x].name;
    sel.value = country[x].name;
    document.getElementById("airportDepart").appendChild(sel);
  }
  $("#aiportDest").select2({
    placeholder: "",
    // allowClear: true,
