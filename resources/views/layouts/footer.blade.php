            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 mb-4">
                    <div class="footer-links">
                        ...
                        <div class="tagcloud">
                            <a class="tag-cloud-link bg-white black p-2 mb-1" href="{{ route('flight') }}">Flight
                                Booking</a>
                            <a class="tag-cloud-link bg-white black p-2 mb-1" href="{{ route('car_hire') }}">Car
                                Hire</a>
                            <a class="tag-cloud-link bg-white black p-2 mb-1"
                                href="{{ route('apartments.all') }}">Accomodation</a>
        ...
        <div class="container">
            <div class="copyright-inner d-md-flex align-items-center justify-content-center">
                <div class="copyright-text">
                    <p class="m-0 white"> <a href="abisiniya.com">{{ date('Y')}} Abisiniya. All rights reserved.</a></p>
                </div>
