                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto  pb-1 pt-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu   <?php echo e(Route::currentRouteName() == 'flight' ? 'active' : ''); ?>" aria-labelledby="navbarDropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu   <?php echo e(Route::currentRouteName() == 'car_hire' ? 'active' : ''); ?>" aria-labelledby="navbarDropdown">
                       ...
                       <li class="nav-item  <?php echo e(Route::currentRouteName() == 'corporatetravel.create' ? 'active' : ''); ?>">
