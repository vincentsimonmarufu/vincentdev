             ...
             <?php if(auth()->user()->role == 'admin'): ?>
                 <li>
                     ...
                     <ul>
                         ...
                         <li> <a class="collapse-item" href="<?php echo e(route('users.type', 'shuttle')); ?>">Airport Shuttle
                                 Owners</a>
                         </li>
                     </ul>
                 </li>
                 ...
                 <li>
                     ...
                     <ul>
                         <li> <a class="collapse-item" href="<?php echo e(route('roles.index')); ?>">All Roles</a>
                         </li>
                     </ul>
                 </li>
                 <li>
                     ...
                     <ul>
                         <li> <a class="collapse-item" href="<?php echo e(route('permissions.index')); ?>">All Permissions</a>
                         </li>
                     </ul>
                 </li>
                 ...
                 <li>
                     ...
                     <ul>
                         ...
                         <li><a class="collapse-item" href="<?php echo e(route('flightrequests.index')); ?>">Flight Requests</a>
                         </li>
                     </ul>
                 </li>
                 <li>
                 ...
                 <li>
                     ...
                     <ul>
                         ...
                         <li> <a class="collapse-item"
                                 href="<?php echo e(route('users.bus.index', auth()->user()->id)); ?>">Buses</a>
                         </li>
 ...
 <!-- End of Sidebar -->
<?php /**PATH C:\Users\vince\Documents\Workspace\Abisiniya\abisiniya82\resources\views/layouts/auth/sidebar.blade.php ENDPATH**/ ?>